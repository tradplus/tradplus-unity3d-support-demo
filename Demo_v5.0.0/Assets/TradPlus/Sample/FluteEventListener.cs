...
public class FluteEventListener : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        //广告展示
        TradPlusManager.OnAdExpandedEvent += OnAdExpandedEvent;
        ...
        //针对整个广告位加载的结果做一个状态的返回（多缓存）
        TradPlusManager.OnOfferWallAllLoadedEvent += OnOfferWallAllLoadedEvent;
    ...
    // Native Events
    private void OnAdNativeLoadedEvent(string adUnitId, float height, string channalName)
    {
        Debug.Log("OnAdNativeLoadedEvent: " + adUnitId + " height: " + height + "channelName : " + channalName);
    }


    private void OnAdNativeFailedEvent(string adUnitId, string error)
    {
        Debug.Log("OnAdNativeFailedEvent: " + adUnitId + "error :"+ error);
    }


    private void OnAdNativeClickedEvent(string adUnitId)
    {
        Debug.Log("OnAdNativeClickedEvent: " + adUnitId);
    }


    private void OnAdNativeExpandedEvent(string adUnitId)
    {
        Debug.Log("OnAdNativeExpandedEvent: " + adUnitId);
    ...
    private void OnOfferWallAllLoadedEvent(bool isLoadedSucces, string adUnitId)
    {
        Debug.Log("OnOfferWallAllLoadedEvent: " + adUnitId + "OnOfferWallAllLoadedEvent:: " + " isLoadedSucces:" + isLoadedSucces);
