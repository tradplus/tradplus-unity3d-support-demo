...
public class TradPlusBinding
{
  ...
  // Queries if a OfferWall ad has been loaded for the given ad unit id.
    ...
    private static void _tradplusShowInterstitialAd(string adUnitId,string adSceneId) {}
    ...
    private static void _tradplusShowInterstitialEntryAdScenario(string adUnitId) {}
    private static void _tradplusShowInterstitialEntryAdScenario(string adUnitId,string adSceneId) {}
    ...
    private static void _tradplusShowRewardedVideo(string adUnitId,string adSceneId) {}
    ...
    private static void _tradplusShowRewardedVideoEntryAdScenario(string adUnitId) {}
    private static void _tradplusShowRewardedVideoEntryAdScenario(string adUnitId,string adSceneId) {}
