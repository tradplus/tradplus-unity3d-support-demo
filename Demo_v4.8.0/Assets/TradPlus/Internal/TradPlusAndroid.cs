...
public class TradPlusAndroid : TradPlusBase
{
    ...
    //CCPA
    public static void setCCPA(bool isCCPA)
    {
        PluginClass.CallStatic("setCCPA", isCCPA);
    }
    ...
    //进入广告场景
    public static void ShowBannerEntryAdScenario(string adUnitId)
    {
        MPBanner plugin;
        if (BannerPluginsDict.TryGetValue(adUnitId, out plugin))
            plugin.ShowBannerEntryAdScenario();
        else
            ReportAdUnitNotFound(adUnitId);
    }
    ...
    //进入广告场景
    public static void ShowNativeEntryAdScenario(string adUnitId)
    {
        MPNative plugin;
        if (NativePluginsDict.TryGetValue(adUnitId, out plugin))
            plugin.ShowNativeEntryAdScenario();
        else
            ReportAdUnitNotFound(adUnitId);
    }
    ...
    public static void ShowInterstitialEntryAdScenario(string adUnitId)
    {
        MPInterstitial plugin;
        if (InterstitialPluginsDict.TryGetValue(adUnitId, out plugin))
            plugin.ShowInterstitialEntryAdScenario();
        else
            ReportAdUnitNotFound(adUnitId);
    }
    ...
    public static void ShowInterstitialEntryAdScenario(string adUnitId, string adSceneId)
    {
        MPInterstitial plugin;
        if (InterstitialPluginsDict.TryGetValue(adUnitId, out plugin))
            plugin.ShowInterstitialEntryAdScenario(adSceneId);
        else
            ReportAdUnitNotFound(adUnitId);
    }
    ...
    public static void ShowRewardedVideoEntryAdScenario(string adUnitId)
    {
        MPRewardedVideo plugin;
        if (RewardedVideoPluginsDict.TryGetValue(adUnitId, out plugin))
            plugin.ShowRewardedVideoEntryAdScenario();
        else
            ReportAdUnitNotFound(adUnitId);
    }
    ...
    public static void ShowRewardedVideoEntryAdScenario(string adUnitId,string adSceneId)
    {
        MPRewardedVideo plugin;
        if (RewardedVideoPluginsDict.TryGetValue(adUnitId, out plugin))
            plugin.ShowRewardedVideoEntryAdScenario(adSceneId);
        else
            ReportAdUnitNotFound(adUnitId);
    }
    ...
    //进入广告场景
    public static void ShowOfferWallEntryAdScenario(string adUnitId)
    {
        MPOfferWall plugin;
        if (OfferWallPluginsDict.TryGetValue(adUnitId, out plugin))
            plugin.ShowOfferWallEntryAdScenario();
        else
            ReportAdUnitNotFound(adUnitId);
    }

    //进入广告场景（广告场景ID）
    public static void ShowOfferWallEntryAdScenario(string adUnitId, string adSceneId)
    {
        MPOfferWall plugin;
        if (OfferWallPluginsDict.TryGetValue(adUnitId, out plugin))
            plugin.ShowOfferWallEntryAdScenario(adSceneId);
        else
            ReportAdUnitNotFound(adUnitId);
    }
