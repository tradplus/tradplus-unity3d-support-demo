...
public class FluteDemoGUI : MonoBehaviour
{
    ...
    //private readonly string _nativeAdUnits = "A11BFAC79E0E76B572E2381C3D458353";
    //private readonly string _nativeAdUnits2 = "B8E554EB2A9B874F564649D473F10B0E";
    ...
    private void CreateBannersSection()
    {
        ...
        if (GUILayout.Button(CreateRequestButtonLabel(_bannerAdUnits)))
        {
            ...
            //进入广告场景页面调用
            TradPlus.ShowBannerEntryAdScenario(_bannerAdUnits);
        }
    ...
    private void CreatNativesSection()
    {
        ...
        if (GUILayout.Button(CreateRequestButtonLabel(_nativeAdUnits)))
        {
            ...
            //请求Native广告，设置 X Y
            // TradPlus.CreateNative(_nativeAdUnits,0,0);
            //进入广告场景页面调用
            TradPlus.ShowNativeEntryAdScenario(_nativeAdUnits);
        }
    ...
    private void CreateInterstitialsSection()
    {
        ...
        if (GUILayout.Button("Show"))
        {
            ...
            //进入场景时调用 
            TradPlus.ShowInterstitialEntryAdScenario(_interstitialAdUnits);
    ...
    private void CreateRewardedVideosSection()
    {
        ...
        if (GUILayout.Button("Show"))
        {
            ClearStatusLabel();
            //进入场景时调用
            TradPlus.ShowRewardedVideoEntryAdScenario(_rewardedVideoAdUnits);
            //设置自动reload为true,无可用广告会自动加载；有广告时直接展示
    ...
    private void CreateOfferWallSection()
    {
        ...
        if (GUILayout.Button("Show"))
        {
            ClearStatusLabel();
            //进入场景时调用
            TradPlus.ShowOfferWallEntryAdScenario(_offerWallAdUnits);
