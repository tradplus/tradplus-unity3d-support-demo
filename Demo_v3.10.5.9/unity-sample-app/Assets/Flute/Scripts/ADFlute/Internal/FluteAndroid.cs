...
using UnityEngine;
using MPBanner = FluteAndroidBanner;
using MPInterstitial = FluteAndroidInterstitial;
using MPRewardedVideo = FluteAndroidRewardedVideo;

[SuppressMessage("ReSharper", "UnusedMember.Global")]
public class FluteAndroid : FluteBase
{
	static FluteAndroid()
    {
        InitManager();
	...
	private static readonly AndroidJavaClass PluginClass = new AndroidJavaClass("com.flute.ads.unity.FluteUnityPlugin");
