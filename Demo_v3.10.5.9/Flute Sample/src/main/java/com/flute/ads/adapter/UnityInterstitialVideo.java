...
//        mInterstitialListener = customEventInterstitialListener;
        ...
        UnityPidReward unityPidReward = new UnityPidReward(mCurrencyName,mAmount);
        unityInterstitialCallbackRouter.addPidListener(placementId, unityPidReward);
        ...
        UnityAdsListener unityAdsListener = new UnityAdsListener(placementId,mCurrencyName,mAmount,true);
