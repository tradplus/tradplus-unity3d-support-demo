...
public class FluteDemoGUI : MonoBehaviour
{
    ...
    private void CreateNativeBannerSection()
    {
        ...
        if (GUILayout.Button(CreateRequestButtonLabel(_nativebannerAdUnits)))
        {
            ...
            TradPlus.CreateNativeBanner(_nativebannerAdUnits, TradPlusBase.AdPosition.BottomCenter);
        ...
        if (GUILayout.Button("Show"))
        {
            ClearStatusLabel();
            //展示广告
            TradPlus.HideNativeBanner(_nativebannerAdUnits, true);
        ...
        if (GUILayout.Button("Hide"))
        {
            ClearStatusLabel();
            //隐藏广告
            TradPlus.HideNativeBanner(_nativebannerAdUnits, false);
